...
!(function (t) {
    ...
    var c,
        ...
        v =
            ...
            ["fa", "fas", "far", "fal", "fat", "fad", "fadr", "fadl", "fadt", "fab", "fass", "fasr", "fasl", "fast", "fasds", "fasdr", "fasdl", "fasdt"].concat(
    ...
    []
        .concat(
            ((l = Object.keys({ classic: ["fas", "far", "fal", "fat", "fad"], duotone: ["fadr", "fadl", "fadt"], sharp: ["fass", "fasr", "fasl", "fast"], "sharp-duotone": ["fasds", "fasdr", "fasdl", "fasdt"] })),
            (function (t) {
    ...
    function Y(t, n) {
        ...
        return (
            ...
            r.push(
                new R(function (r, o) {
                    H((t.subsetPath && t.baseUrl + "/" + t.subsetPath) || A(t, { minify: t.minify.enabled }), n)
                        .then(function (t) {
                            ...
                            G(function () {
                                ...
                                var t = (function (t, e) {
                                    ...
                                    return (
                                        ...
                                        (n.src = A(t, { baseFilename: "conflict-detection", fileSuffix: "js", subdir: "js", minify: t.minify.enabled })),
                                        n
                                    );
                                })(J, Q);
